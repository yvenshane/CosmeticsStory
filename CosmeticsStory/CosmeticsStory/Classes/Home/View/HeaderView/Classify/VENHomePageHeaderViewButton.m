...
//        self.imageURLString = imageURLString;
        ...
        } else if (self.buttonTitleLabelFontSize == 11.0f) {
            self.buttonTitleLabelHeight = 14.0f;
        }
...
- (void)setFrame:(CGRect)frame {
    ...
    self.buttonImage.frame = CGRectMake((self.frame.size.width - self.buttonImageWidth) / 2, 24, self.buttonImageWidth, self.buttonImageWidth);
