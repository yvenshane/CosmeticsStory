...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"成分评论";
...
- (IBAction)sendButtonClick:(id)sender {
    if (self.contentTextView.text.length > 0) {
        ...
        [[VENApiManager sharedManager] releaseCommentWithParameters:parameters images:self.imagesMuArr keyName:@"images" successBlock:^(id  _Nonnull responseObject) {
