//
//  VENHomePageSearchCompositionDetailsPageModel.h
//  CosmeticsStory
//
...
@interface VENHomePageSearchCompositionDetailsPageModel : NSObject
@property (nonatomic, copy) NSString *acne;
...
@property (nonatomic, copy) NSString *name_alias;
